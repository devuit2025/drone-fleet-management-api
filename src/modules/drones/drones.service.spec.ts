...
describe('DronesService', () => {
    ...
    describe('findBySerialNumber', () => {
        ...
        it('should throw NotFoundException when drone not found', async () => {
            ...
            await expect(service.findBySerialNumber('DRONE-999')).rejects.toThrow(
                NotFoundException,
            );
    ...
    describe('updateStatus', () => {
        ...
        it('should update drone status successfully', async () => {
            ...
            expect(mockDroneRepository.findById).toHaveBeenCalledWith(1);
            expect(mockDroneRepository.updateStatus).toHaveBeenCalledWith(
                1,
                updateStatusDto.status,
            );
            expect(mockDroneRepository.updateBatteryCapacity).toHaveBeenCalledWith(
                1,
                updateStatusDto.battery_capacity,
            );
        });
        ...
        it('should update status without battery capacity', async () => {
            ...
            expect(mockDroneRepository.updateStatus).toHaveBeenCalledWith(
                1,
                updateStatusDtoWithoutBattery.status,
            );
